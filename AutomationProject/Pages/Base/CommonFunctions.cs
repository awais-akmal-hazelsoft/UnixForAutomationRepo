...
namespace UnixFor.Pages.Base
{
    public static class CommonFunctions
    {
        ...
        //button elements
        public static By svgBtn = By.XPath("(//div[@title='Toggle SortBy'])[1]");
        public static By paginationNextBtn = By.XPath("(//li[@class='pagination__item page-item']/button[@class='pagination__link pagination__link--arrow page-link'])[2]");
        public static By updateBtn = By.CssSelector("div.form__form-group>button");
        public static By adminBtn = By.XPath("//a[text()='Admin']");
        public static By logoutBtn = By.XPath("//button[span[text()='Logout']]");
        public static By filterBtn = By.XPath("//button[./span[text()='Filter']]");
        public static By applyFilterBtn = By.XPath("//button[text()='Apply Filter']");
        //Dropdown elements
        public static By paginationSizingDropdown = By.XPath("//select[@id='exampleSelect']");
        public static By paginationSizingDropdownItem = By.XPath("//select[@id='exampleSelect' ]//option[@Value='50']");
        //others elements
        public static By ascendingOrderSvg = By.XPath("//th[@class='thead tr wordbreak-audit']//*[local-name()='svg']/*[local-name()='path' and @d='M19 17H22L18 21L14 17H17V3H19M2 17H12V19H2M6 5V7H2V5M2 11H9V13H2V11Z']");
        public static By decendingOrderSvg = By.XPath("//th[@class='thead tr wordbreak-audit']//*[local-name()='svg']/*[local-name()='path' and @d='M18 21L14 17H17V7H14L18 3L22 7H19V17H22M2 19V17H12V19M2 13V11H9V13M2 7V5H6V7H2Z']");
        public static By loadingSpinner = By.CssSelector("div.spinner");
        public static By paginationInfoList = By.XPath("//*[@id='root']/div[2]/div/main/div/div[2]/div/div[5]/div/div/div[1]/div[1]/nav/ul/div/li[text()='Showing']");
        public static By tableHead = By.XPath("//table/thead/tr");
        public static By filterNameDropdown = By.Name("field0");
        public static By filterTypeDropdown = By.Name("type0");
        public static By filterValueDropDown = By.Name("value0");
        //property to get dashboard heading 
        public static By dashboardHeading
        {
            get
            {
        ...
        public static void SetDriver(IWebDriver d)
        {
            driver = d;
        }
        //methos to click on menu item
        public static void ClickOnMenuOption(By menuElement, By itemElement)
        {
        ...
        public static void CheckAscendingSorting(string columnName)
        {
        ...
        public static List<string> GetColumnText(List<IWebElement> webElementslist)
        {
        ...
        public static List<string> GetColumnTextFromAllPages(string columnName)
        {
        ...
        public static void CheckDescendingSorting(string columnName)
        {
            List<string> beforeSortingValues = GetColumnTextFromAllPages(Constants.NameColumnHeadingtext);
            beforeSortingValues.Sort();
        ...
        public static List<IWebElement> GetColumnWebElements(string columnName)
        {
            //paginationInfoNumbers[0] is starting Number of row in current page
            //paginationInfoNumbers[1] is Ending row in current page
            //paginationInfoNumbers[2] is total Number of rows in table
        ...
        public static void FilterNumbers(ref int[] num)
        {
            WaitUntilInvisible(loadingSpinner);
        ...
        public static void CheckReadOnlyView(By element)
        {
        ...
        public static void ActiveRecord(string filterName, string filterValue, string nameKey)
        {
        ...
        public static void CheckFilter(string filterName, string filterValue, string searchText)
        {
            WaitUntilInvisible(loadingSpinner);
            Assert.IsTrue(IsElementVisible(filterBtn), "Filter button is not displayed");
            GetElement(filterBtn).Click();
